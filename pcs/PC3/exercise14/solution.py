...
def frames_of_a_textured_sphere_rotating(
    full_path_input_mesh,
    full_path_input_texture,
    rotation_line,
    ...
    for frame in range(360):
        ...
        R = rotation_matrix(rotation_line, theta)
        rotated_vertices = apply_rotation(vertices, R)
        
        output_image_path = f"{filename_without_suffix_output_frames}-{frame + 1}.png"
