...
def sphere_with_triangular_faces(full_path_output_file, radius, center):
...
sphere_with_triangular_faces(
    full_path_output_file = 'sphere-triangles.off',
    radius = 5,
    center = (2,3,5)
)

sphere_with_triangular_faces(
    full_path_output_file = 'sphere-triangles.ply',
    radius = 5,
    center = (2,3,5)
)
